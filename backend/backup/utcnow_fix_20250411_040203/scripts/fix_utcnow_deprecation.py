...
def fix_utcnow_deprecation(fix_all=True, dry_run=False):
    ...
    import_patterns = [
        ...
        (r'from\s+datetime\s+import\s+datetime\b(?!,\s*UTC\b)', r'from datetime import datetime, UTC'),
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Fix deprecated datetime.utcnow() calls")
