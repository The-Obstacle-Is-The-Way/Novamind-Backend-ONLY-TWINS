...
"""
import uuid
from typing import Any, Dict, List, Optionalclass MockAsyncSession:
    ...
    def __init__(self, data):
        ...
        return self.data[0] if self.data else Noneclass MockEntityFactory:
    ...
    def __init__(self):
        ...
        if entity_id in self.entities:
            ...
            return True
            return Falseclass RoleBasedAccessControl:
