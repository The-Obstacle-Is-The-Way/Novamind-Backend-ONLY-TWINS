...
class SecurityTestRunner:
    ...
    def __init__(self, output_path: str = None):
        ...
        self.test_categories = [
            ...
            {'name': 'Enhanced Security', 'pattern': '../unit/infrastructure/security/test_encryption_enhanced.py'},
    ...
    def run_pytest(self, test_file: str) -> Dict[str, Any]:
        ...
        cmd = [
            ...
            test_file, "--json-report", "--no-header", "--no-summary"
        ]
    ...
    def run_category(self, category: Dict[str, str]) -> None:
        ...
        for test_file in test_files:
            ...
            # Print file summary
            print(f"  Passed: {parsed_results['summary']['passed']}/{parsed_results['summary']['total']}")
    ...
    def run_all_tests(self) -> None:
        ...
        if self.results['summary']['total'] > 0:
            success_rate = 100 * self.results['summary']['passed'] / self.results['summary']['total']
        ...
        if os.environ.get('GENERATE_DASHBOARD', 'true').lower() == 'true':
            try:
                ...
                dashboard_path = os.path.join(self.output_path, f"dashboard_{datetime.now().strftime('%Y%m%d_%H%M%S')}.html")
