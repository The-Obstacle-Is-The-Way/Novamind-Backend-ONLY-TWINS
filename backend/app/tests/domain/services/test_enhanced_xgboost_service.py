...
class TestEnhancedXGBoostService:
    ...
    def test_predict_treatment_response_with_baseline(
    ...
    def test_prediction_different_neurotransmitters(
        ...
        ), "Predictions should differ by neurotransmitter"

    def test_positive_vs_negative_treatment_effects(
        self, xgboost_service, test_patient_id, test_baseline_data
    ):
        ...
        assert (
            positive_prediction["predicted_response"]
            != negative_prediction["predicted_response"]
