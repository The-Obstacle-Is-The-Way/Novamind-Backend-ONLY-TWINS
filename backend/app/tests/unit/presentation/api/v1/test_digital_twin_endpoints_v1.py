...
def mock_digital_twin_service(mocker: MockerFixture):
    ...
    mocker.patch("app.presentation.api.dependencies.get_digital_twin_service", return_value=service_mock)
    return service_mock
...
class TestDigitalTwinEndpoints:
    ...
    def test_create_digital_twin(self, mock_digital_twin_service, sample_twin_data):
        ...
        mock_digital_twin_service.create_digital_twin.assert_called_once_with("patient-123")
    ...
    def test_get_digital_twin(self, mock_digital_twin_service, sample_twin_data):
        ...
        # Verify service called correctly
        mock_digital_twin_service.get_digital_twin.assert_called_once_with("patient-123")
    ...
    def test_get_digital_twin_summary(
        ...
        # Configure mocks
        mock_digital_twin_service.get_digital_twin.return_value = sample_twin_data
        mock_digital_twin_service.get_latest_biometrics.return_value = sample_latest_biometrics
        ...
        # Verify service called correctly
        mock_digital_twin_service.get_digital_twin.assert_called_once_with("patient-123")
        mock_digital_twin_service.get_latest_biometrics.assert_called_once_with("patient-123")
    ...
    def test_add_biometric_data_error(self, mock_digital_twin_service, sample_biometric_data):
    ...
    def test_get_biometric_history(self, mock_digital_twin_service):
        ...
        # Make request
        response = client.get("/api/v1/digital-twins/patient/patient-123/biometrics/heart_rate")
    ...
    def test_get_abnormal_values(self, mock_digital_twin_service, sample_abnormal_values):
        """Test getting abnormal values."""
        # Configure mock
        mock_digital_twin_service.detect_abnormal_values.return_value = sample_abnormal_values
        ...
        # Verify service called correctly
        mock_digital_twin_service.detect_abnormal_values.assert_called_once_with("patient-123")
    ...
    def test_get_critical_values(self, mock_digital_twin_service, sample_critical_values):
        """Test getting critical values."""
        # Configure mock
        mock_digital_twin_service.detect_critical_values.return_value = sample_critical_values
        ...
        # Verify service called correctly
        mock_digital_twin_service.detect_critical_values.assert_called_once_with("patient-123")
