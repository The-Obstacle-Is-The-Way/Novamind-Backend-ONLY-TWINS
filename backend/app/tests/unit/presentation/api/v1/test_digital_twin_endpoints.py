...
class TestDigitalTwinEndpoints:
    ...
    async def test_get_digital_twin(
        ...
        response = test_client.get(
            f"/api/v1/patients/{sample_digital_twin['patient_id']}/digital-twin"
        )
    ...
    async def test_get_digital_twin_not_found(
        ...
        response = test_client.post(
            f"/api/v1/patients/{patient_id}/digital-twin/biometrics", json=data
        )
    ...
    async def test_update_digital_twin(
        ...
        response = test_client.patch(
            f"/api/v1/patients/{patient_id}/digital-twin", json=update_data
        )
    ...
    async def test_error_handling(
        ...
        # Setup mocks
        mock_get_service.return_value = mock_digital_twin_service
        mock_digital_twin_service.add_biometric_data.side_effect = ValueError(
