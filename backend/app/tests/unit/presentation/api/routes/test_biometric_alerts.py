...
def mock_repository():
    ...
    repository.get_alerts_by_patient = AsyncMock()
    return repository
...
def sample_alert_data():
    ...
    return {
        ...
        "priority": AlertPriorityEnum.MEDIUM.value,
...
def override_dependencies(app, mock_repository, mock_current_user, mock_current_provider):
    ...
    class TestGetPatientAlerts:
        ...
        async def test_get_patient_alerts_success(self, client, mock_repository, sample_alert):
            ...
            mock_repository.get_alerts_by_patient.return_value = [sample_alert]
            ...
            mock_repository.get_alerts_by_patient.assert_called_once()
            call_args, call_kwargs = mock_repository.get_alerts_by_patient.call_args
        ...
        async def test_get_patient_alerts_with_filters(self, client, mock_repository, sample_alert):
            ...
            response = client.get(f"/biometric-alerts/patient/{patient_id}?status=new&page=2&page_size=10")
        ...
        async def test_get_patient_alerts_repository_error(self, client, mock_repository):
            ...
            # Setup
            patient_id = uuid4()
            mock_repository.get_alerts_by_patient.side_effect = RepositoryError("Database error")
    ...
    class TestGetActiveAlerts:
        ...
        async def test_get_active_alerts_success(self, client, mock_repository, sample_alert):
            ...
            # Setup
            mock_repository.get_all.return_value = [sample_alert]
            ...
            call_args, call_kwargs = mock_repository.get_all.call_args
        ...
        async def test_get_active_alerts_with_priority_filter(self, client, mock_repository, sample_alert):
            ...
            response = client.get("/biometric-alerts/active?priority=urgent&page=2&page_size=10")
        ...
        async def test_get_active_alerts_repository_error(self, client, mock_repository):
            """Test error handling when the repository raises an error."""
            # Setup
            mock_repository.get_all.side_effect = RepositoryError("Database error")
    ...
    class TestUpdateAlertStatus:
        ...
        async def test_update_alert_status_success(self, client, mock_repository, sample_alert, mock_current_provider):
            ...
            mock_repository.update.return_value = updated_alert
            ...
            call_args, call_kwargs = mock_repository.update.call_args
        ...
        async def test_update_alert_status_not_found(self, client, mock_repository):
            ...
            # Setup
            alert_id = uuid4()
            mock_repository.update.side_effect = EntityNotFoundError(f"Biometric alert with ID {alert_id} not found")
        ...
        async def test_update_alert_status_repository_error(self, client, mock_repository):
            ...
            # Setup
            alert_id = uuid4()
            mock_repository.update.side_effect = RepositoryError("Database error")
