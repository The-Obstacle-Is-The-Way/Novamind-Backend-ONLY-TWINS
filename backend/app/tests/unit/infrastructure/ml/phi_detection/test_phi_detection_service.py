...
def phi_detection_service():
    ...
    # Mock the patterns file content
    mock_patterns = """
    contact:
    ...
    # Correct indentation for the patch blocks
    with patch("builtins.open", mock_open(read_data=mock_patterns)):
        with patch.object(PHIDetectionService, "_get_default_patterns", return_value=[]):
            ...
            # yield service # Use yield if cleanup is needed
            return service # Return the configured service instance
