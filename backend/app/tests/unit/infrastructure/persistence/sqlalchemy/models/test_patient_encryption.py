...
from app.infrastructure.security.encryption import encrypt_value, decrypt_value, get_encryption_key
...
class TestPatientEncryption:
    ...
    @patch("app.infrastructure.security.encryption.get_encryption_key")
    def test_patient_property_updates(self, mock_get_key, mock_encryption_key, patient_data):
