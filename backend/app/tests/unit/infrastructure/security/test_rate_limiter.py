...
def redis_rate_limiter(mock_redis):
    ...
    return RedisRateLimiter(redis_client=mock_redis)class TestRateLimitConfig:
    ...
    def test_init_with_mock(self, mock_redis):
        ...
        mock_redis.delete.assert_any_call("rate_limit_block:test-key")class TestRateLimiterFactory:
