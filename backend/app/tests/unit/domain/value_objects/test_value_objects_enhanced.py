...
@pytest.mark.venv_only()class TestEmergencyContact:
    """Comprehensive tests for the EmergencyContact value object."""@pytest.fixture
def valid_contact_data(self) -> Dict[str, Any]:
    ...
    def test_emergency_contact_creation(self, valid_contact_data):
        ...
        assert contact_dict["address"]["street"] == valid_contact_data["address"]["street"]class TestPsychiatricAssessment:
    """Comprehensive tests for the PsychiatricAssessment value object."""@pytest.fixture
def valid_assessment_data(self) -> Dict[str, Any]:
    ...
    def test_psychiatric_assessment_creation(self, valid_assessment_data):
        ...
        def test_psychiatric_assessment_optional_fields(
        ...
        assert assessment.assessment_date == valid_assessment_data["assessment_date"]
        assert assessment.diagnosis == valid_assessment_data["diagnosis"]
        assert assessment.severity == valid_assessment_data["severity"]class TestAddressValueObject:
    """Tests for the Address value object."""@pytest.fixture
def valid_address_data(self) -> Dict[str, Any]:
    ...
    def test_address_creation(self, valid_address_data):
        ...
        # Dictionary should contain all attributes
        assert address_dict == valid_address_dataclass TestContactInfoValueObject:
    """Tests for the ContactInfo value object."""@pytest.fixture
def valid_contact_info_data(self) -> Dict[str, Any]:
    ...
    def test_contact_info_creation(self, valid_contact_info_data):
        ...
        assert contact_info.preferred_contact_method == valid_contact_info_data[
