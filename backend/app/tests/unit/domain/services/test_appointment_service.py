...
# Removed AppointmentNotFoundException,   PatientNotFoundException,
...
def valid_appointment(future_datetime):
    ...
    @pytest.mark.venv_only()class TestAppointmentService:
    ...
    def test_get_appointment(
        ...
        appointment_repository.get_by_id.assert_called_once_with(
        ...
        def test_get_appointments_for_patient(
                self,
                appointment_service,
                appointment_repository,
                valid_appointment):
        ...
        appointment_repository.get_by_patient_id.return_value = [
            valid_appointment]

        # Get the appointments
        appointments = appointment_service.get_appointments_for_patient(
            "patient123")
        ...
        def test_get_appointments_for_patient_not_found(
                self, appointment_service, patient_repository):
        ...
        def test_get_appointments_for_provider(
                self,
                appointment_service,
                appointment_repository,
                valid_appointment):
        ...
        # Get the appointments
        appointments = appointment_service.get_appointments_for_provider(
            "provider456")
        ...
        def test_get_appointments_for_provider_not_found(
                self, appointment_service, provider_repository):
        ...
        def test_create_appointment_with_default_end_time(
                self, appointment_service, future_datetime):
        ...
        def test_create_appointment_patient_not_found(
                self, appointment_service, patient_repository, future_datetime):
        ...
        def test_create_appointment_provider_not_found(
                self, appointment_service, provider_repository, future_datetime):
        ...
        def test_reschedule_appointment_with_default_end_time(
                self,
                appointment_service,
                appointment_repository,
                valid_appointment,
        ...
        # Check the appointment
        assert updated_appointment.start_time == new_start_time
        assert updated_appointment.end_time == new_start_time + \
            timedelta(hours=1)
        ...
        def test_reschedule_appointment_conflict(
                self,
                appointment_service,
                appointment_repository,
                valid_appointment,
        ...
        assert follow_up_appointment.end_time == follow_up_time + \
            timedelta(hours=1)
        ...
        # Check that the repository was called twice (once for the follow-up,
