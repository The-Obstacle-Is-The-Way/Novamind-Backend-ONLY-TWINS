...
#             return observer
        ...
        @pytest.mark.venv_only()  # Assuming venv_only is a valid markerclass TestBiometricEventProcessor:
...
def test_process_data_point_inactive_rule()
            self, sample_data_point, sample_rule):
                ...
                def test_process_data_point_updates_context(self, sample_data_point):
                    ...
                    assert context["latest_values"][sample_data_point.data_type] == sample_data_point.valueclass TestAlertRule:
