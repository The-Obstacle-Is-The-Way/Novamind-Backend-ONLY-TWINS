...
class TestClinicalRuleEngine:
    ...
    async def test_create_rule(self, rule_engine, mock_rule_repository, 
        ...
        # Setup
        mock_rule_repository.save.return_value = MagicMock()
        ...
        # Verify
        assert mock_rule_repository.save.call_count  ==  1
    ...
    async def test_update_rule(self, rule_engine, mock_rule_repository, sample_rule):
        ...
        mock_rule_repository.save.return_value = sample_rule
        ...
        # Verify
        mock_rule_repository.get_by_id.assert _called_once_with(rule_id)
        assert mock_rule_repository.save.call_count  ==  1
    ...
    async def test_create_standard_rules(self, rule_engine, mock_rule_repository, 
        ...
        # Setup
        mock_rule_repository.save.side_effect = lambda rule: rule
    ...
    async def test_get_active_rules_for_patient(self, rule_engine, mock_rule_repository, 
        ...
        mock_rule_repository.get_by_patient_id.assert _called_once_with(sample_patient_id)
        mock_rule_repository.get_all_active.assert _called_once()