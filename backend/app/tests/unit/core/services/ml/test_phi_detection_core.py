...
@pytest.fixture
    def mock_comprehend_response_with_phi(self):
        """Create a mock AWS Comprehend Medical response with PHI."""    return {
        "Entities": [
        {
        "BeginOffset": 11,
        "EndOffset": 19,
...
@pytest.fixture
    def mock_comprehend_response_without_phi(self):
            """Create a mock AWS Comprehend Medical response without PHI."""    return {
            "Entities": [],
            "UnmappedAttributes": [],
            "ModelVersion": "0.1.0"
            }
@pytest.fixture
    ...
    def test_initialization(self):
                    ...
                    mock_boto3.assert _called_once()
