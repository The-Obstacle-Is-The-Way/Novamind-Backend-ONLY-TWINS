...
def sample_readings():
    ...
    for i in range(100):
        ...
        return readings@pytest.fixture
def sample_device_info():
    ...
    def test_initialization_success(self):
        ...
        for i in range(5):
            ...
            result = mock_pat.get_patient_analyses(
                "test-patient", limit=2, offset=1)
