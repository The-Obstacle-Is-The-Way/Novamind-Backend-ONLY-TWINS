...
db_patcher = mock.patch("app.infrastructure.persistence.sqlalchemy.config.database.get_db_instance", get_db_mock)
base_patcher = mock.patch("app.infrastructure.persistence.sqlalchemy.config.database.Base", base_mock)
engine_patcher = mock.patch("app.infrastructure.persistence.sqlalchemy.config.database.engine", engine_mock)
...
def mock_db_session():
    ...
    """
    with mock.patch("app.infrastructure.persistence.sqlalchemy.database.SessionLocal") as mock_session:
