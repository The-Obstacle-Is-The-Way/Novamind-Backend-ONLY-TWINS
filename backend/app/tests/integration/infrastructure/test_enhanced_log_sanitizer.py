...
@pytest.mark.db_required()class TestPHIPattern:
    ...
    def test_phi_pattern_matches_regex(self):
        ...
        assert not pattern.matches("", None)class TestPatternRepository:
    ...
    def test_add_pattern(self):
        ...
        assert any(p.name == "Custom Pattern" for p in patterns)class TestRedactionStrategies:
