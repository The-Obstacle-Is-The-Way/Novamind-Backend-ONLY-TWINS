...
class TestPatientRepository:
    ...
    async def test_get_patient_by_id(self, repository, sample_patient_data):
        ...
        # Verify patient was retrieved correctly
    ...
    @pytest.mark.asyncio
    async def test_get_patient_by_email(self, repository, sample_patient_data):
        """Test retrieving a patient by email."""
        # Create a patient first
        created_patient = await repository.create(sample_patient_data)
        
        # Retrieve the patient
        retrieved_patient = await repository.get_by_email(created_patient.email)
