...
def test_app(mock_pat: MockPAT) -> FastAPI:
    ...
    Args:
        mock_pat: Configured MockPAT instance
    ...
    # Override the PAT service dependency to use the MockPAT instance
    app.dependency_overrides[get_pat_service] = lambda: mock_pat
