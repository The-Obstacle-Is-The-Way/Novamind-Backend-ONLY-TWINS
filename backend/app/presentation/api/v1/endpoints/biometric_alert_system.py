# -*- coding: utf-8 -*-
"""
FastAPI endpoints for the biometric alert system.

This module provides API endpoints for the real-time biometric alert system,
which monitors biometric data streams and triggers clinical interventions
...
router = APIRouter(
    prefix="/biometric-alert-system",
    tags=["biometric-alert-system"],
    responses={
...
async def get_patient_alerts(
    ...
    status_filter: Optional[AlertStatusEnum] = Query(None, alias="status", description="Filter by alert status"),
    ...
    try:
        ...
        alert_status = AlertStatus(status_filter.value) if status_filter else None
